...
const int PassedFriendlyDistance[8] = { 0,  0,  3,  7,  6, -8, -15,  0};
const int PassedEnemyDistance[8] = { 0,  3,  5,  9,  1,  7,  24,  0};
const int PassedFriendlyDistanceEG[8] = { 0,  0,  -4, -10, -14, -13, -9,  0};
const int PassedEnemyDistanceEG[8] = { 0,  0,  2,  9,  21,  30,  28,  0};

const int Connected[8] = { 0, 7, 8, 12, 29, 48, 86, 0};
const int PawnBackwards[2] = {  7, -7};
const int PawnBackwardsEG[2] = {  0, -19};
...
const int KingO[64] = { 
  75  , 80  ,  0  , -10 , -10 , -10 , 80  , 75  ,
  76  , 78  ,  0  , -40 , -40 , -35 , 78  , 76  ,
